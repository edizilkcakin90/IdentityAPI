...
namespace DAL
{
    ...
    {
        public const string ApiName = "identityserver_api";
        public const string ApiFriendlyName = "IdentityServer API";
        public const string QuickAppClientID = "identityserver_spa";
